                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Ready to pick</div>
                                            <?php
                                            $total_ready_orders = 0;
                                            $select_ready_orders = $conn->prepare("SELECT COUNT(*) as total_ready FROM orders WHERE payment_status = ?");
                                            $select_ready_orders->execute(['ready']);
                                            $fetch_ready_orders = $select_ready_orders->fetch(PDO::FETCH_ASSOC);
                                            $total_ready_orders = $fetch_ready_orders['total_ready'];
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_ready_orders; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            // print_r($fetch_completed_orders);
                                            // exit();
