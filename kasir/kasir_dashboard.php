                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Handling by you</div>

                                            <?php
                                            $total_handling_by_you = 0;
                                            $select_handling_orders = $conn->prepare("SELECT COUNT(*) as total_handling FROM orders WHERE kasir_id = ?");
                                            $select_handling_orders->execute([$kasir_id]);
                                            $fetch_handling_orders = $select_handling_orders->fetch(PDO::FETCH_ASSOC);
                                            $total_handling_by_you = $fetch_handling_orders['total_handling'];
                                            ?>

                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_handling_by_you; ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            // Memanggil fungsi untuk mendapatkan data harian
                                            $monthlyChartData = getDailyChartData($conn);

                                            // Menghitung total pendapatan bulanan
                                            $totalMonthlyEarnings = array_sum($monthlyChartData['data']);
                                            ?>

                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp <?= number_format($totalMonthlyEarnings, 0, ',', '.'); ?></div>
                                        </div>
                                        <div class="col-auto">
